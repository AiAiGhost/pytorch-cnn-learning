...
class CNN(nn.Module):
    def __init__(self, n_classes, pretrained = False):
        ...
        self.inception3 = InceptionBlock(inplanes = 128, planes_1x1 = 32, planes_3x3_mid = 32,
        ...
        self.inception4 = InceptionBlock(inplanes = 256, planes_1x1 = 64, planes_3x3_mid = 64,
