...
class BasicBlock(nn.Module):
    def __init__(self, inplanes, outplanes, kernel_size, isResAdd = True, need_pool = True):
        ...
        self.conv1 = nn.Conv2d(inplanes, outplanes, kernel_size, 1, 1, bias=False)
        self.bn1 = nn.BatchNorm2d(outplanes)
        self.relu1 = nn.ReLU()

        self.conv2 = nn.Conv2d(outplanes, outplanes, kernel_size, 1, 1, bias=False)
...
class CNN(nn.Module):
    def __init__(self, n_classes):
        ...
        self.conv5 = BasicBlock(256, 512, 3)
        self.conv55 = BasicBlock(512, 512, 3, need_pool=False)
