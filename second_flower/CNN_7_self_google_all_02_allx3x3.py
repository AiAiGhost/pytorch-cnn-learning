...
class InceptionBlock(nn.Module):
    def __init__(self, inplanes, planes_1x1, planes_3x3_mid, planes_3x3, planes_5x5_mid, planes_5x5, planes_maxpool):
        ...
        planes_7x7_mid = planes_7x7 = planes_maxpool
        ...
        self.conv5x5 = nn.Sequential(
            ...
            BasicConv2d(planes_5x5_mid, planes_5x5_mid, kernel_size = 3, stride = 1, padding = 1),
            BasicConv2d(planes_5x5_mid, planes_5x5, kernel_size = 3, stride = 1, padding = 1),
        )

        # 7x7
        self.conv7x7 = nn.Sequential(
            BasicConv2d(inplanes, planes_7x7_mid, kernel_size=1, stride=1, padding=0),
            BasicConv2d(planes_7x7_mid, planes_7x7_mid, kernel_size = 3, stride = 1, padding = 1),
            BasicConv2d(planes_7x7_mid, planes_7x7_mid, kernel_size = 3, stride = 1, padding = 1),
            BasicConv2d(planes_7x7_mid, planes_7x7, kernel_size = 3, stride = 1, padding = 1),
        )
    ...
    def forward(self, x):
        ...
        outputs = [conv1x1, conv3x3, conv5x5,conv7x7]   #maxpool1
