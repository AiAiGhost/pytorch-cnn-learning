...
class CNN(nn.Module):
    def __init__(self, n_classes, pretrained = False):
        ...
        self.inception33 = InceptionBlock(inplanes = 128, planes_1x1 = 48, planes_3x3_mid = 48,
                                         planes_3x3 = 48, planes_5x5_mid = 16, planes_5x5 = 16, planes_maxpool = 16)

        self.inception333 = InceptionBlock(inplanes = 128, planes_1x1 = 48, planes_3x3_mid = 16,
                                         planes_3x3 = 16, planes_5x5_mid = 48, planes_5x5 = 48, planes_maxpool = 16)

        self.inception3333 = InceptionBlock(inplanes = 128, planes_1x1 = 16, planes_3x3_mid = 48,
                                         planes_3x3 = 48, planes_5x5_mid = 48, planes_5x5 = 48, planes_maxpool = 16)
        ...
        self.inception44 = InceptionBlock(inplanes = 256, planes_1x1 = 96, planes_3x3_mid = 96,
                                         planes_3x3 = 96, planes_5x5_mid = 32, planes_5x5 = 32, planes_maxpool = 32)
        self.inception444 = InceptionBlock(inplanes = 256, planes_1x1 = 96, planes_3x3_mid = 32,
                                         planes_3x3 = 32, planes_5x5_mid = 96, planes_5x5 = 96, planes_maxpool = 32)
        self.inception4444 = InceptionBlock(inplanes = 256, planes_1x1 = 32, planes_3x3_mid = 96,
                                         planes_3x3 = 96, planes_5x5_mid = 96, planes_5x5 = 96, planes_maxpool = 32)
    ...
    def forward(self, x):
        ...
        x = self.inception333(x)
        x = self.inception3333(x)
        x = self.maxpool4(x)
        #x = self.conv4(x)
        #x = self.conv44(x)
        x = self.inception4(x)
        x = self.inception44(x)
        x = self.inception444(x)
        x = self.inception4444(x)
        #x = self.conv5(x)
        x = self.maxpool5(x)
        x = self.inception5(x)
