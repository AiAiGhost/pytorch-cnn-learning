...
class CNN(nn.Module):
    def __init__(self, n_classes, pretrained = False):
        ...
        self.inception3 = InceptionBlock(inplanes = 128, planes_1x1 = 64, planes_3x3_mid = 32,
                                         planes_3x3 = 64, planes_5x5_mid = 32, planes_5x5 = 64, planes_maxpool = 64)

        self.inception33 = InceptionBlock(inplanes = 256, planes_1x1 = 64, planes_3x3_mid = 32,
                                         planes_3x3 = 64, planes_5x5_mid = 32, planes_5x5 = 64, planes_maxpool = 64)

        self.maxpool4 = nn.MaxPool2d(3, stride=2, ceil_mode=True)
        self.inception4 = InceptionBlock(inplanes = 256, planes_1x1 = 128, planes_3x3_mid = 64,
                                         planes_3x3 = 128, planes_5x5_mid = 64, planes_5x5 = 128, planes_maxpool = 128)

        self.inception44 = InceptionBlock(inplanes = 512, planes_1x1 = 128, planes_3x3_mid = 64,
                                         planes_3x3 = 128, planes_5x5_mid = 64, planes_5x5 = 128, planes_maxpool = 128)

        self.maxpool5 = nn.MaxPool2d(3, stride=2, ceil_mode=True)
        self.inception5 = InceptionBlock(inplanes = 512, planes_1x1 = 256, planes_3x3_mid = 128,
                                         planes_3x3 = 256, planes_5x5_mid = 128, planes_5x5 = 256, planes_maxpool = 256)

        self.inception55 = InceptionBlock(inplanes = 1024, planes_1x1 = 256, planes_3x3_mid = 128,
                                         planes_3x3 = 256, planes_5x5_mid = 128, planes_5x5 = 256, planes_maxpool = 256)
