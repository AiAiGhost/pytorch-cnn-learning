...
class CNN(nn.Module):
    def __init__(self, n_classes, pretrained = False):
        ...
        #self.conv1 = BasicBlock(3, 64, 3, False)
        self.conv1 = nn.Conv2d(3, 64, kernel_size = 7, stride = 2, padding = 3)
        self.bn1 = nn.BatchNorm2d(64)
        self.relu1 = nn.ReLU()

        self.inception1 = InceptionBlock(inplanes = 64, planes_1x1 = 16, planes_3x3_mid = 16,
                                         planes_3x3 = 16, planes_5x5_mid = 16, planes_5x5 = 16, planes_maxpool = 16)
        self.maxpool2 = nn.MaxPool2d(3, stride=2, ceil_mode=True)
        self.inception2 = InceptionBlock(inplanes = 64, planes_1x1 = 32, planes_3x3_mid = 32,
                                         planes_3x3 = 32, planes_5x5_mid = 32, planes_5x5 = 32, planes_maxpool = 32)

        self.maxpool3 = nn.MaxPool2d(3, stride=2, ceil_mode=True)
        self.inception3 = InceptionBlock(inplanes = 128, planes_1x1 = 64, planes_3x3_mid = 64,
                                         planes_3x3 = 64, planes_5x5_mid = 64, planes_5x5 = 64, planes_maxpool = 64)

        self.maxpool4 = nn.MaxPool2d(3, stride=2, ceil_mode=True)
        self.inception4 = InceptionBlock(inplanes = 256, planes_1x1 = 128, planes_3x3_mid = 128,
                                         planes_3x3 = 128, planes_5x5_mid = 128, planes_5x5 = 128, planes_maxpool = 128)

        self.maxpool5 = nn.MaxPool2d(3, stride=2, ceil_mode=True)
        self.inception5 = InceptionBlock(inplanes = 512, planes_1x1 = 256, planes_3x3_mid = 256,
                                         planes_3x3 = 256, planes_5x5_mid = 256, planes_5x5 = 256, planes_maxpool = 256)

        self.out = nn.Linear(1024 * 7 * 7, n_classes)  # 全连接层得到的结果
