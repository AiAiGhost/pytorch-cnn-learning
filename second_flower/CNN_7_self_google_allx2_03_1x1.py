...
class CNN(nn.Module):
    def __init__(self, n_classes, pretrained = False):
        ...
        self.inception2 = InceptionBlock(inplanes = 32, planes_1x1 = 16, planes_3x3_mid = 8,
                                         planes_3x3 = 16, planes_5x5_mid = 8, planes_5x5 = 16, planes_maxpool = 16)
        self.inception22 = InceptionBlock(inplanes = 64, planes_1x1 = 16, planes_3x3_mid = 8,
                                         planes_3x3 = 16, planes_5x5_mid = 8, planes_5x5 = 16, planes_maxpool = 16)

        self.maxpool3 = nn.MaxPool2d(3, stride=2, ceil_mode=True)
        #self.conv3 = BasicBlock(64, 128, 3)
        #self.conv33 = BasicBlock(128, 128, 3, need_pool=False)
        self.inception3 = InceptionBlock(inplanes = 64, planes_1x1 = 32, planes_3x3_mid = 16,
                                         planes_3x3 = 32, planes_5x5_mid = 16, planes_5x5 = 32, planes_maxpool = 32)
        self.inception33 = InceptionBlock(inplanes = 128, planes_1x1 = 32, planes_3x3_mid = 16,
                                         planes_3x3 = 32, planes_5x5_mid = 16, planes_5x5 = 32, planes_maxpool = 32)

        self.maxpool4 = nn.MaxPool2d(3, stride=2, ceil_mode=True)
        #self.conv4 = BasicBlock(128, 256, 3)
        #self.conv44 = BasicBlock(256, 256, 3, need_pool=False)
        self.inception4 = InceptionBlock(inplanes = 128, planes_1x1 = 64, planes_3x3_mid = 32,
                                         planes_3x3 = 64, planes_5x5_mid = 32, planes_5x5 = 64, planes_maxpool = 64)
        self.inception44 = InceptionBlock(inplanes = 256, planes_1x1 = 64, planes_3x3_mid = 32,
                                         planes_3x3 = 64, planes_5x5_mid = 32, planes_5x5 = 64, planes_maxpool = 64)
        ...
        self.inception5 = InceptionBlock(inplanes = 256, planes_1x1 = 128, planes_3x3_mid = 64,
                                         planes_3x3 = 128, planes_5x5_mid = 64, planes_5x5 = 128, planes_maxpool = 128)
        self.inception55 = InceptionBlock(inplanes = 512, planes_1x1 = 128, planes_3x3_mid = 64,
                                         planes_3x3 = 128, planes_5x5_mid = 64, planes_5x5 = 128, planes_maxpool = 128)
